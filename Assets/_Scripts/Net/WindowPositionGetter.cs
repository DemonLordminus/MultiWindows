...
public class WindowPositionGetter : MonoBehaviour
{
    ...
    public int offsetX => ScreenSizeX/2;
    public int offsetY => ScreenSizeY/2;
    [Serializable]
    private struct RECT
    {
        public int left;
    ...
    void Start()
    {
        ...
        // {
        //     SetWindowsPositionToCenter_UnUse();
        // }
    ...
    public int ScreenSizeX = 500, ScreenSizeY = 500;
    ...
    [EditorButton]
    public void SetWindowsPositionToCenter_UnUse()
    {
